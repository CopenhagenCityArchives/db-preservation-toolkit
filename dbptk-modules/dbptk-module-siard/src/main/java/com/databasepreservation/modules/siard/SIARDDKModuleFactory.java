...
public class SIARDDKModuleFactory implements DatabaseModuleFactory {
  ...
  private static final Parameter PARAM_IMPORT_AS_SCHEMA = new Parameter()
    .shortName("as")
    .longName(PARAMETER_AS_SCHEMA)
    .description(
  ...
  private static final Parameter lobsPerFolder = new Parameter()
    .shortName("lpf")
    .longName(PARAMETER_LOBS_PER_FOLDER)
  ...
  public DatabaseImportModule buildImportModule(Map<Parameter, String> parameters, Reporter reporter)
    ...
    reporter.importModuleParameters(getModuleName(), "file", Paths.get(parameters.get(folder)).normalize()
