...
public class SIARD1ModuleFactory implements DatabaseModuleFactory {
  ...
  private static final Parameter tableFilter = new Parameter()
    .shortName("tf")
    .longName(PARAMETER_TABLE_FILTER)
    .description(
  ...
  private static final Parameter metaArchiverContact = new Parameter()
    .shortName("mac")
  ...
  private static final Parameter metaDataOwner = new Parameter()
    .shortName("mdo")
    .longName(PARAMETER_META_DATA_OWNER)
    .description(
  ...
  private static final Parameter metaDataOriginTimespan = new Parameter()
    .shortName("mdot")
  ...
  private static final Parameter metaClientMachine = new Parameter()
    .shortName("mcm")
