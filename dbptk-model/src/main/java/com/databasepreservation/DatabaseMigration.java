...
public class DatabaseMigration {
  ...
  /**
   * Sets the import module factory that will be used to produce the import
   * module
   */
  ...
  /**
   * Sets the export module factory that will be used to produce the import
   * module
   */
  ...
  /**
   * Adds the specified filter to this database migration. Multiple filters can
   * be added, and the database information will go through them in the same
   * order they were added here
   */
