...
public class IdentityFilter implements DatabaseFilterModule {
  ...
  /**
   * Method meant to be used by subclasses of IdentityFilter ONLY. And only
   * after the reporter has been set.
   *
   * @return The reported that can be used by classes that inherit
   *         IdentityFilter.
   */
